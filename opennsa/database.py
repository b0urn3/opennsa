...
def setupDatabase(host, database, user, password=None):
    ...
    Registry.DBPOOL = adbapi.ConnectionPool('psycopg2', host=host, user=user, password=password, database=database)
